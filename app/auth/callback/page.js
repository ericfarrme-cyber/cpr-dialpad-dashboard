...
export default function AuthCallback() {
  ...
  return (
    <div style={{ minHeight:"100vh",display:"flex",alignItems:"center",justifyContent:"center",background:"#0B0D11",color:"var(--text-primary)",fontFamily:"-apple-system,sans-serif" }}>
