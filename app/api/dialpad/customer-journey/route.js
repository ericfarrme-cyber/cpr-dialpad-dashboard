...
export async function GET(request) {
  ...
  if (action === "lookup" && phone) {
    ...
    var { data: audits, error: aErr } = await supabase
      .from("audit_results")
      .select("call_id, employee, store, score, call_type, inquiry, outcome, date_started, talk_duration, confidence, transcript_preview, appt_offered, discount_mentioned, warranty_mentioned, status_update_given, eta_communicated, professional_tone, next_steps_explained")
